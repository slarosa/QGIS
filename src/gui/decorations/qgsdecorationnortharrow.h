 ...
 * \brief Main class for north arrow map decoration
 *
 * \since QGIS 3.16
 */
class GUI_EXPORT QgsDecorationNorthArrow: public QgsDecorationItem
{
    Q_OBJECT
  ...
  public:
     ...
     */
    QgsDecorationNorthArrow( QObject *parent SIP_TRANSFERTHIS = nullptr );
