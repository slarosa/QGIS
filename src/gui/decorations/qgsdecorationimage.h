 ...
 * \brief Main class for image map decoration
 *
 * \since QGIS 3.16
 */
class GUI_EXPORT QgsDecorationImage: public QgsDecorationItem
{
    Q_OBJECT
  ...
  public:
     ...
     */
    QgsDecorationImage( QObject *parent SIP_TRANSFERTHIS = nullptr );
