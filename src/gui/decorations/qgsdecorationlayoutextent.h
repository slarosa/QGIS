 ...
 * \brief Main class for layout extent map decoration
 *
 * \since QGIS 3.16
 */
class GUI_EXPORT QgsDecorationLayoutExtent : public QgsDecorationItem
{
    Q_OBJECT
  public:
    ...
    */
    QgsDecorationLayoutExtent( QObject *parent SIP_TRANSFERTHIS = nullptr );
