 ...
 * \brief Dialog for layout extent map decoration
 *
 * \since QGIS 3.16
 */
class GUI_EXPORT QgsDecorationLayoutExtentDialog : public QDialog, private Ui::QgsDecorationLayoutExtentDialog
{
    Q_OBJECT

  public:
    QgsDecorationLayoutExtentDialog( QgsDecorationLayoutExtent &decoration, QWidget *parent SIP_TRANSFERTHIS = nullptr );
