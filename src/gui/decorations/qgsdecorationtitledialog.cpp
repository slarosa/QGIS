  ...
  , mDeco( deco )
{
  ...
  mButtonFontStyle->setMapCanvas( mDeco.mCanvas );
...
void QgsDecorationTitleDialog::mInsertExpressionButton_clicked()
{
  ...
  QgsExpressionBuilderDialog exprDlg( nullptr, selText, this, QStringLiteral( "generic" ), mDeco.mCanvas->mapSettings().expressionContext() );
