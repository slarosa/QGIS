 ...
 * \brief Main class for scale bar map decoration
 *
 * \since QGIS 3.16
 */
class GUI_EXPORT QgsDecorationScaleBar: public QgsDecorationItem
{
    Q_OBJECT
  public:
    //! Constructor
    QgsDecorationScaleBar( QObject *parent SIP_TRANSFERTHIS = nullptr );
