...
/**
 * \ingroup gui
 * \class QgsDecorationGridDialog
 * \brief Dialog for grid map decoration
 *
 * \since QGIS 3.16
 */
class GUI_EXPORT QgsDecorationGridDialog : public QDialog, private Ui::QgsDecorationGridDialog
{
    Q_OBJECT

  public:
    QgsDecorationGridDialog( QgsDecorationGrid &decoGrid, QWidget *parent SIP_TRANSFERTHIS = nullptr );
