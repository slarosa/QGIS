 ...
 * \brief Main class for grid map decoration
 *
 * \since QGIS 3.16
 */
class GUI_EXPORT QgsDecorationGrid: public QgsDecorationItem
{
  ...
  public:
    ...
    //! Constructor
    QgsDecorationGrid( QObject *parent SIP_TRANSFERTHIS = nullptr );
